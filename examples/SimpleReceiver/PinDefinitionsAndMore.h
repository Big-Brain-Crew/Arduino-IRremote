...
#define IR_RECEIVE_PIN      D2  // GPIO15 to be compatible with the Arduino Nano RP2040 Connect (pin3)
#define IR_SEND_PIN         D3  // GPIO16
#define TONE_PIN            D0
#define APPLICATION_PIN     D5
#define ALTERNATIVE_IR_FEEDBACK_LED_PIN D6 // E.g. used for examples which use LED_BUILDIN for example output.
#define _IR_TIMING_TEST_PIN D7
